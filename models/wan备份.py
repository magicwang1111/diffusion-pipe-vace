...
class WanModelFromSafetensors(WanModel):
    ...
    def from_pretrained(
        ...
        **_unused,
        ...
        # 如果是 VACE 模型，可能需要添加额外的参数
        if model_type == 'vace':
            # 添加 VACE 特有的参数
            vace_specific_params = ['vace_layers', 'vace_in_dim']
            for param in vace_specific_params:
                if param in cfg_dict and param in wan_model_params:
                    filtered_cfg[param] = cfg_dict[param]
